...
def view_students():
    ...
    # Print the data
    print(
        f"{'Name':<10}{'Student Number':<16}{'Age':<8}{'Year Grade':<12}{'Test-1':<8}{'Test-2':<8}{'Test-3':<8}{'Test-4':<8}"
        )
    for index, row in enumerate(data[1:], start=1):
        print(f"{index}. {row[0]:<10}{row[1]:<16}{row[2]:<8}{row[3]:<12}{row[4]:<8}{row[5]:<8}{row[6]:<8}{row[7]:<8}")
